  ...
  <div>
    ...
    <PageLayout>
      ...
      <div className={`${styles.section} ${styles.section1}`}>
        ...
        <p className={paragraph}>Since moving to Kansas City, Dr. Amore has enjoyed meeting the people in her new community and exploring the restaurants and nightlife. She loves feeling connected to nature and all things that allow total presence in the moment. She is a travel enthusiast, loves yoga and meditation, cooking, and spending time with her family back home in New Orleans, Louisiana.</p>
      </div>
    </PageLayout>
  </div>
);
