...
const Footer = (): ReactElement => (
  <footer className='bg-aliceblue flex flex-col items-center justify-around py-12 px-5 shadow-container text-center md:flex-row md:items-center'>
    <FooterNavigation />
    <div className='my-12 order-3 md:my-0 md:order-none md:self-end'>
